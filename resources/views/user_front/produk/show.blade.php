    ...
    <section id="breadcrumbs" class="pt-6 bg-gray-50">
        <div class="container mx-auto px-4">
            <ol class="list-reset flex">
                ...
                <li><a href="{{ route('produk') }}" class="font-semibold hover:text-primary">Shop</a></li>
                <li><span class="mx-2">&gt;</span></li>
                <li><a href="category.html" class="font-semibold hover:text-primary">{{ $produk['nama'] }}</a></li>
            </ol>
        </div>
    </section>
                ...
                <div class="flex flex-col lg:flex-row gap-6">
                    ...
                    <div class="w-full lg:w-1/2">
                        <div class="grid gap-4">
                            ...
                            <div class="grid grid-cols-5 gap-4">
                                <div>
                                    <img onclick="changeImage(this)" data-full="assets/images/single-product/1.jpg"
                                        src="{{ asset('assets/user_front/images/utility-cargo-jeans.png') }}"
                                        class="object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer"
                                        alt="Gallery Image 1" />
                                </div>
                                <div>
                                    <img onclick="changeImage(this)" data-full="assets/images/single-product/2.jpg"
                                        src="{{ asset('assets/user_front/images/cream-wide-leg-pants.png') }}"
                                        class="object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer"
                                        alt="Gallery Image 2" />
                                </div>
                                <div>
                                    <img onclick="changeImage(this)" data-full="assets/images/single-product/3.jpg"
                                        src="{{ asset('assets/user_front/images/contrast-track-pants.png') }}"
                                        class="object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer"
                                        alt="Gallery Image 3" />
                                </div>
                                <div>
                                    <img onclick="changeImage(this)" data-full="assets/images/single-product/4.jpg"
                                        src="{{ asset('assets/user_front/images/classic-cargo-pants.png') }}"
                                        class="object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer"
                                        alt="Gallery Image 4" />
                                </div>
                                <div>
                                    <img onclick="changeImage(this)" data-full="assets/images/single-product/5.jpg"
                                        src="{{ asset('assets/user_front/images/washed-wide-jeans.png') }}"
                                        class="object-cover object-center max-h-30 max-w-full rounded-lg cursor-pointer"
                                        alt="Gallery Image 5" />
                                </div>
                            </div>
                    ...
                    <div class="w-full lg:w-1/2 flex flex-col justify-between">
                        ...
                        <div class="flex space-x-4 my-6">
                            ...
                            <a href="#" class="w-4 h-4 flex items-center justify-center">
                                <img src="{{ asset('assets/tailstore/images/social_icons/pinterest.svg') }}"
                                    alt="Pinterest" class="w-4 h-4 transition-transform transform hover:scale-110">
                            </a>
                            <a href="#" class="w-4 h-4 flex items-center justify-center">
                            ...
                            <a href="#" class="w-4 h-4 flex items-center justify-center">
                                <img src="{{ asset('assets/tailstore/images/social_icons/viber.svg') }}" alt="Viber"
                                    class="w-4 h-4 transition-transform transform hover:scale-110">
                            </a>
                        </div>
