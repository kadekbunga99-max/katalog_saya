    ...
    <header class="bg-gray-dark sticky top-0 z-50">
        <div class="container mx-auto flex justify-between items-center py-4">
            ...
            <a href="index.html" class="flex items-center">
              <div>
                  <img src="{{asset('assets/tailstore/images/template-white-logo.png')}}" alt="Logo" class="h-14 w-auto mr-4">
              </div>
            </a>
            ...
            <div class="hidden lg:flex items-center space-x-4 relative">
              ...
              <div class="relative group cart-wrapper">
                  <a href="/cart.html" >
                      <img src="{{asset('assets/tailstore/images/cart-shopping.svg')}}" alt="Cart" class="h-6 w-6 group-hover:scale-120">
                  </a>
                  <!-- Cart dropdown -->
                      ...
                      <div class="space-y-4">
                          ...
                          <div class="flex items-center justify-between pb-4 border-b border-gray-line">
                              <div class="flex items-center">
                                  <img src="{{asset('assets/tailstore/images/single-product/1.jpg')}}" alt="Product" class="h-12 w-12 object-cover rounded mr-2">
                                  <div>
                          ...
                          <div class="flex items-center justify-between">
                            <div class="flex items-center">
                                <img src="{{asset('assets/tailstore/images/single-product/2.jpg')}}" alt="Product" class="h-12 w-12 object-cover rounded mr-2">
                                <div>
