     ...
     <div class="container mx-auto flex justify-between items-center py-4">
             ...
             <ul class="flex justify-center space-x-4 text-white">
                 ...
                 <li class="relative group" x-data="{ open: false }">
                     ...
                     <ul x-show="open" @mouseover="open = true" @mouseleave="open = false"
                         ...
                         x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-90">
                         <li><a href="shop.html"
                                 class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Women Item
                                 1</a></li>
                         <li><a href="shop.html"
                                 class="min-w-40 block px-4 py-2 hover:bg-primary hover:text-white rounded">Women Item
                                 2</a></li>
                 ...
                 <li><a href="{{ route('produk') }}" class="hover:text-secondary font-semibold">Shop</a></li>
         ...
         <div class="hidden lg:flex items-center space-x-4 relative">
             ...
             <div class="relative group cart-wrapper">
                 <a href="/cart.html">
                     <img src="{{ asset('assets/tailstore/images/cart-shopping.svg') }}" alt="Cart"
                 ...
                 <div class="absolute right-0 mt-1 w-80 bg-white shadow-lg p-4 rounded hidden group-hover:block">
                     <div class="space-y-4">
                         ...
                         <div class="flex items-center justify-between">
                             <div class="flex items-center">
                                 <img src="{{ asset('assets/tailstore/images/single-product/2.jpg') }}" alt="Product"
                                     class="h-12 w-12 object-cover rounded mr-2">
                                 <div>
