        ...
        <div class="main-slider swiper-container">
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="{{ asset('assets/user_front/images/hero1.png') }}" alt="Product 1">
                    <div class="swiper-slide-content">
                        <h2 class="text-3xl md:text-7xl font-bold text-white mb-2 md:mb-4">
                            Koleksi Baggy
                        </h2>
                        <p class="mb-4 text-white md:text-2xl">
                            Tampil lebih percaya diri dengan <br>
                            denim pilihan untuk gaya sehari-hari.
                        </p>
                        <a href="/"
                ...
                <!-- Slide 2 -->
                <div class="swiper-slide">
                    <img src="{{ asset('assets/user_front/images/hero2.png') }}" alt="Product 2">
                    <div class="swiper-slide-content">
                        <h2 class="text-3xl md:text-7xl font-bold text-white mb-2 md:mb-4">
                            Gaya Kasual
                        </h2>
                        <p class="mb-4 text-white md:text-2xl">
                            Temukan pilihan outfit kasual <br>
                            yang nyaman untuk setiap aktivitas.
                        </p>
                        <a href="/"
                            class="bg-primary hover:bg-transparent text-white hover:text-white border border-transparent hover:border-white font-semibold px-4 py-2 rounded-full inline-block">
                            Lihat Koleksi
                ...
                <!-- Slide 3 -->
                <div class="swiper-slide">
                    <img src="{{ asset('assets/user_front/images/hero3.png') }}" alt="Product 3">
                    <div class="swiper-slide-content">
                        <h2 class="text-3xl md:text-7xl font-bold text-white mb-2 md:mb-4">
                            Lengkapi Gaya
                        </h2>
                        <p class="mb-4 text-white md:text-2xl">
                            Tambahkan sentuhan akhir dengan <br>
                            aksesori pilihan untuk gayamu.
                        </p>
                        <a href="/"
                            class="bg-primary hover:bg-transparent text-white hover:text-white border border-transparent hover:border-white font-semibold px-4 py-2 rounded-full inline-block">
                            Shop Now
